...
func loadCSV2(fileName: String) -> [Dialogue2] {
    ...
    do {
        ...
        for row in rows.dropFirst() {
            ...
            // choice2Percentageの取得とDoubleへの変換
            let choice2PercentageString = getValue("choice2Percentage")
            let choice2PercentageValue = Double(choice2PercentageString ?? "")
            ...
            let dialogue = Dialogue2(
                ...
                choice1Percentage: choice1PercentageValue, // ✅ 修正
                choice1NextSceneId: getValue("choice1NextSceneId"),
                choice2Text: getValue("choice2Text"),
                choice2Percentage: choice2PercentageValue, // ✅ 修正
